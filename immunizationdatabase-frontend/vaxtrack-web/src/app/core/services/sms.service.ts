...
export class SmsService {
  ...
  sendSms(phone: string, message: string): Observable<SmsLog> {return this.http.post<any>(`${this.apiUrl}/api/sms-logs/send`, { phone, message }).pipe(
      map((response: any) => ({
  ...
  deleteSmsLog(id: string): Observable<void> {return this.http.delete<void>(`${this.apiUrl}/api/sms-logs/${id}`);
  }
}
