...
export class VaccinatorAppointmentsComponent implements OnInit {
  ...
  loadAppointments(): void {
    ...
    if (!facilityId) {
      ...
      next: (appointments) => {this.appointments = appointments || [];this.applyFilters();ensureMinimumLoadingTime(startTime, () => {
          this.loading = false;
          this.isLoadingData = false;
      ...
      error: (error) => {
        console.error('Failed to load appointments:', error);this.appointments = [];
